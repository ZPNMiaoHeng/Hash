...
void Vsha1_top___024root__traceChgSub0(Vsha1_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgIData(oldp+2,(vlSelf->sha1_top__DOT__a_temp),32);
            tracep->chgIData(oldp+3,(vlSelf->sha1_top__DOT__b_temp),32);
            tracep->chgIData(oldp+4,(vlSelf->sha1_top__DOT__c_temp),32);
            tracep->chgIData(oldp+5,(vlSelf->sha1_top__DOT__d_temp),32);
            tracep->chgIData(oldp+6,(vlSelf->sha1_top__DOT__e_temp),32);
            tracep->chgWData(oldp+7,(vlSelf->sha1_top__DOT__r_din_temp),160);
            tracep->chgWData(oldp+12,(vlSelf->sha1_top__DOT__r_din),160);
            tracep->chgCData(oldp+17,(vlSelf->sha1_top__DOT__u_con__DOT__s_cur),2);
            tracep->chgWData(oldp+18,(vlSelf->sha1_top__DOT__u_w__DOT__din_temp),512);
            ...
            tracep->chgWData(oldp+34,(__Vtemp44),512);
            tracep->chgIData(oldp+50,(vlSelf->sha1_top__DOT__u_w__DOT__w_gen_temp),32);
            tracep->chgIData(oldp+51,(vlSelf->sha1_top__DOT__u_w__DOT__w_gen),32);
            tracep->chgIData(oldp+52,(vlSelf->sha1_top__DOT__u_round__DOT__f),32);
            tracep->chgIData(oldp+53,(vlSelf->sha1_top__DOT__u_round__DOT__k),32);
            tracep->chgIData(oldp+54,(vlSelf->sha1_top__DOT__u_round__DOT__a_shift),32);
            tracep->chgIData(oldp+55,(vlSelf->sha1_top__DOT__u_round__DOT__b_shift),32);
            tracep->chgIData(oldp+56,(vlSelf->sha1_top__DOT__u_round__DOT__add_result),32);
            tracep->chgIData(oldp+57,(vlSelf->sha1_top__DOT__r_din[4U]),32);
            tracep->chgIData(oldp+58,(vlSelf->sha1_top__DOT__r_din[3U]),32);
            tracep->chgIData(oldp+59,(vlSelf->sha1_top__DOT__r_din[2U]),32);
            tracep->chgIData(oldp+60,(vlSelf->sha1_top__DOT__r_din[1U]),32);
            tracep->chgIData(oldp+61,(vlSelf->sha1_top__DOT__r_din[0U]),32);
        }
        tracep->chgBit(oldp+62,(vlSelf->clk));
        tracep->chgBit(oldp+63,(vlSelf->rst_n));
        tracep->chgBit(oldp+64,(vlSelf->valid));
        tracep->chgWData(oldp+65,(vlSelf->din),512);
        tracep->chgWData(oldp+81,(vlSelf->dout),160);
        tracep->chgBit(oldp+86,(vlSelf->ready));
        tracep->chgCData(oldp+87,(vlSelf->sha1_top__DOT__u_con__DOT__s_next),2);
    }
}
