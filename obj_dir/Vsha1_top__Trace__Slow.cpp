...
void Vsha1_top___024root__traceInitSub0(Vsha1_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+60,"valid", false,-1);
        tracep->declArray(c+61,"din", false,-1, 511,0);
        tracep->declArray(c+77,"dout", false,-1, 159,0);
        tracep->declBit(c+82,"ready", false,-1);
        tracep->declBit(c+58,"sha1_top clk", false,-1);
        tracep->declBit(c+59,"sha1_top rst_n", false,-1);
        tracep->declBit(c+60,"sha1_top valid", false,-1);
        tracep->declArray(c+61,"sha1_top din", false,-1, 511,0);
        tracep->declArray(c+77,"sha1_top dout", false,-1, 159,0);
        tracep->declBit(c+82,"sha1_top ready", false,-1);
        tracep->declBus(c+84,"sha1_top H0", false,-1, 31,0);
        tracep->declBus(c+85,"sha1_top H1", false,-1, 31,0);
        tracep->declBus(c+86,"sha1_top H2", false,-1, 31,0);
        tracep->declBus(c+87,"sha1_top H3", false,-1, 31,0);
        tracep->declBus(c+88,"sha1_top H4", false,-1, 31,0);
        tracep->declBus(c+1,"sha1_top t", false,-1, 7,0);
        tracep->declBus(c+2,"sha1_top w_temp", false,-1, 31,0);
        tracep->declArray(c+3,"sha1_top r_din_temp", false,-1, 159,0);
        tracep->declArray(c+8,"sha1_top r_din", false,-1, 159,0);
        tracep->declBit(c+58,"sha1_top u_con clk", false,-1);
        tracep->declBit(c+59,"sha1_top u_con rst_n", false,-1);
        tracep->declBit(c+60,"sha1_top u_con valid", false,-1);
        tracep->declBus(c+1,"sha1_top u_con t", false,-1, 7,0);
        tracep->declBit(c+82,"sha1_top u_con ready_t", false,-1);
        tracep->declBus(c+89,"sha1_top u_con IDLE", false,-1, 1,0);
        tracep->declBus(c+90,"sha1_top u_con ROUND", false,-1, 1,0);
        tracep->declBus(c+91,"sha1_top u_con DONE", false,-1, 1,0);
        tracep->declBus(c+1,"sha1_top u_con t_tem", false,-1, 7,0);
        tracep->declBus(c+13,"sha1_top u_con s_cur", false,-1, 1,0);
        tracep->declBus(c+83,"sha1_top u_con s_next", false,-1, 1,0);
        tracep->declBus(c+92,"sha1_top u_w N", false,-1, 31,0);
        tracep->declBit(c+58,"sha1_top u_w clk", false,-1);
        tracep->declBit(c+59,"sha1_top u_w rst_n", false,-1);
        tracep->declBit(c+60,"sha1_top u_w valid_w", false,-1);
        tracep->declBus(c+1,"sha1_top u_w t", false,-1, 7,0);
        tracep->declArray(c+61,"sha1_top u_w din", false,-1, 511,0);
        tracep->declBus(c+2,"sha1_top u_w w", false,-1, 31,0);
        tracep->declArray(c+14,"sha1_top u_w din_temp", false,-1, 511,0);
        tracep->declArray(c+30,"sha1_top u_w din_temp_shift", false,-1, 511,0);
        tracep->declBus(c+46,"sha1_top u_w w_gen_temp", false,-1, 31,0);
        tracep->declBus(c+47,"sha1_top u_w w_gen", false,-1, 31,0);
        tracep->declBus(c+92,"sha1_top u_round N", false,-1, 31,0);
        tracep->declArray(c+8,"sha1_top u_round r_din", false,-1, 159,0);
        tracep->declBus(c+2,"sha1_top u_round w", false,-1, 31,0);
        tracep->declBus(c+1,"sha1_top u_round round", false,-1, 7,0);
        tracep->declArray(c+3,"sha1_top u_round r_dout", false,-1, 159,0);
        tracep->declBus(c+48,"sha1_top u_round f", false,-1, 31,0);
        tracep->declBus(c+49,"sha1_top u_round k", false,-1, 31,0);
        tracep->declBus(c+50,"sha1_top u_round a_shift", false,-1, 31,0);
        tracep->declBus(c+51,"sha1_top u_round b_shift", false,-1, 31,0);
        tracep->declBus(c+52,"sha1_top u_round add_result", false,-1, 31,0);
        tracep->declBus(c+53,"sha1_top u_round a", false,-1, 31,0);
        tracep->declBus(c+54,"sha1_top u_round b", false,-1, 31,0);
        tracep->declBus(c+55,"sha1_top u_round c", false,-1, 31,0);
        tracep->declBus(c+56,"sha1_top u_round d", false,-1, 31,0);
        tracep->declBus(c+57,"sha1_top u_round e", false,-1, 31,0);
    }
}
...
void Vsha1_top___024root__traceFullSub0(Vsha1_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullWData(oldp+3,(vlSelf->sha1_top__DOT__r_din_temp),160);
        tracep->fullWData(oldp+8,(vlSelf->sha1_top__DOT__r_din),160);
        tracep->fullCData(oldp+13,(vlSelf->sha1_top__DOT__u_con__DOT__s_cur),2);
        tracep->fullWData(oldp+14,(vlSelf->sha1_top__DOT__u_w__DOT__din_temp),512);
        ...
        tracep->fullWData(oldp+30,(__Vtemp36),512);
        tracep->fullIData(oldp+46,(vlSelf->sha1_top__DOT__u_w__DOT__w_gen_temp),32);
        tracep->fullIData(oldp+47,(vlSelf->sha1_top__DOT__u_w__DOT__w_gen),32);
        tracep->fullIData(oldp+48,(vlSelf->sha1_top__DOT__u_round__DOT__f),32);
        tracep->fullIData(oldp+49,(vlSelf->sha1_top__DOT__u_round__DOT__k),32);
        tracep->fullIData(oldp+50,(vlSelf->sha1_top__DOT__u_round__DOT__a_shift),32);
        tracep->fullIData(oldp+51,(vlSelf->sha1_top__DOT__u_round__DOT__b_shift),32);
        tracep->fullIData(oldp+52,(vlSelf->sha1_top__DOT__u_round__DOT__add_result),32);
        tracep->fullIData(oldp+53,(vlSelf->sha1_top__DOT__r_din[4U]),32);
        tracep->fullIData(oldp+54,(vlSelf->sha1_top__DOT__r_din[3U]),32);
        tracep->fullIData(oldp+55,(vlSelf->sha1_top__DOT__r_din[2U]),32);
        tracep->fullIData(oldp+56,(vlSelf->sha1_top__DOT__r_din[1U]),32);
        tracep->fullIData(oldp+57,(vlSelf->sha1_top__DOT__r_din[0U]),32);
        tracep->fullBit(oldp+58,(vlSelf->clk));
        tracep->fullBit(oldp+59,(vlSelf->rst_n));
        tracep->fullBit(oldp+60,(vlSelf->valid));
        tracep->fullWData(oldp+61,(vlSelf->din),512);
        tracep->fullWData(oldp+77,(vlSelf->dout),160);
        tracep->fullBit(oldp+82,(vlSelf->ready));
        tracep->fullCData(oldp+83,(vlSelf->sha1_top__DOT__u_con__DOT__s_next),2);
        tracep->fullIData(oldp+84,(0x67452301U),32);
        tracep->fullIData(oldp+85,(0xefcdab89U),32);
        tracep->fullIData(oldp+86,(0x98badcfeU),32);
        tracep->fullIData(oldp+87,(0x10325476U),32);
        tracep->fullIData(oldp+88,(0xc3d2e1f0U),32);
        tracep->fullCData(oldp+89,(0U),2);
        tracep->fullCData(oldp+90,(1U),2);
        tracep->fullCData(oldp+91,(2U),2);
        tracep->fullIData(oldp+92,(0x20U),32);
    }
}
